...
{
	public class RouterLL:IComponent, IHandleAfterRender, IDisposable, IRouterEnvelope
	{
...
#pragma warning restore BL0005
		...
		int _phase = 0;
		IDictionary<string,object> _parms=null;
		...
		public async Task SetParametersAsync(ParameterView parameters)
		{
			if (_phase==0) //called from Blazor
			{
				...
				_parms=new Dictionary<string,object>(parameters.ToDictionary());
				_phase=1;
				...
				_phase=2;
				await _router.SetParametersAsync(ParameterView.FromDictionary(_parms));
			}
